# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 15:47:12 2022
...
#Matplotlib
fig = plt.figure()
rt_ax = plt.subplot(212,xlim=(0,CHUNK), ylim=(-limitsize,limitsize))
fft_ax = plt.subplot(211)
fft_ax.set_yscale('log')
fft_ax.set_xlim(0,CHUNK/2 + 1)
fft_ax.set_ylim(1,limitsize*5)
...
WAVE_OUTPUT_FILENAME = datetime.datetime.strftime(datetime.datetime.now(),'%Y%m%d_%H%M%S.wav')
if Recording:
